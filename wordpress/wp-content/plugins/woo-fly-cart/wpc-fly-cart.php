...
! defined( 'WOOFC_VERSION' ) && define( 'WOOFC_VERSION', '3.0.6' );
			...
			class WPCleverWoofc {
							...
							<?php if ( $active_tab === 'settings' ) { ?>
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Share cart', 'woofc' ); ?></th>
                                            <td>
				...
				function woofc_get_cart_area() {
					...
					if ( is_array( $items ) && ( count( $items ) > 0 ) ) {
						if ( apply_filters( 'woofc_cart_items_reverse', true ) ) {
					...
					if ( ! empty( $items ) ) {
						if ( get_option( '_woofc_empty', 'no' ) === 'yes' || get_option( '_woofc_share', 'yes' ) === 'yes' ) {
							...
							if ( get_option( '_woofc_share', 'yes' ) === 'yes' ) {
								$cart_html .= '<div class="woofc-share"><span class="woofc-share-cart wpcss-btn" data-hash="' . esc_attr( WC()->cart->get_cart_hash() ) . '">' . esc_html__( 'Share Cart', 'woofc' ) . '</span></div>';
							}
